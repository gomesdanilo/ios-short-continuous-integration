...
//
//  Created by Danilo Gomes on 19/09/2017.
...
class RomanNumeralCalculatorUITests: XCTestCase {
    ...
    func testAddOnePlusOne() {
        ...
        let calculatedText = app.staticTexts["calculated_value"]
        
        
        // Tap I
        iButton.tap()
        XCTAssertEqual(calculatedText.label, "I")
        ...
        // Tap I
        iButton.tap()
        XCTAssertEqual(calculatedText.label, "II")
